 ...
 */
final class Version20230222130645 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE membre (id INT AUTO_INCREMENT NOT NULL, evenement_id INT DEFAULT NULL, rendezvous_id INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, date_naiss DATE NOT NULL, telephone VARCHAR(255) NOT NULL, adress VARCHAR(255) NOT NULL, role VARCHAR(255) NOT NULL, INDEX IDX_F6B4FB29FD02F13 (evenement_id), INDEX IDX_F6B4FB293345E0A3 (rendezvous_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
